...
python ../clustering.py -f DATA/explanation_2D.dat --dim 2 --sens 1.5 -o out-dpa_2D --maxknn 1500
python ../clustering.py -f DATA/s4.dat --dim 2 --sens 1.2 -o out-dpa_s4 --maxknn 1500
python ../clustering.py -f DATA/xy_5000_puntos_5cluster_orig.dat --dim 2 --sens 2.1 -o out-dpa_xy --maxknn 500
